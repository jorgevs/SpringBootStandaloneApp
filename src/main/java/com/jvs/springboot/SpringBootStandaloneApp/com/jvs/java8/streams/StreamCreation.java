...
public class StreamCreation {
    ...
    public static void main(String[] Args) {
        ...
        Stream<Long> longStreamEmpty = Stream.empty();
        Stream<Object> objStreamEmpty = Stream.empty();
        ...
        int[] intNumbers = {4, 5, 6, 7, 2, 4};
        IntStream intStream2 = IntStream.of(intNumbers);

        //rangeClosed(int startInclusive, int endInclusive)
        LongStream longStreamRange = LongStream.rangeClosed(1, 3);
